...
//
//     final belajarApi = belajarApiFromJson(jsonString);

import 'dart:convert';

List<BelajarApi> belajarApiFromJson(String str) =>
    List<BelajarApi>.from(json.decode(str).map((x) => BelajarApi.fromJson(x)));

String belajarApiToJson(List<BelajarApi> data) =>
...
class BelajarApi {
  ...
  factory BelajarApi.fromJson(Map<String, dynamic> json) => BelajarApi(
        id: json["id"],
